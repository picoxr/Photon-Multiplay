...
#pragma warning disable 649
	...
	public class Launcher : MonoBehaviourPunCallbacks
	{
		...
		[Tooltip("The openid of Pico user")]
		public string UserOpenId;

		[Tooltip("The user name of Pico user")]
		public string UserName;

		private UserMessage m_PicoUserMessage;
		#endregion
        ...
        private void Start()
        {
			...
			m_PicoUserMessage = GameObject.Find("PicoPayment").GetComponent<UserMessage>();
		...
		public override void OnJoinedRoom()
		{
			...
			if (PhotonNetwork.CurrentRoom.PlayerCount == 1)
			{
				...
				// #Critical
				// Load the Room Level. 
				PhotonNetwork.LoadLevel("PicoDemo-Room for 1");
